...
/**
 * @link https://github.com/kornrunner/php-keccak/blob/1.0.2/src/Keccak.php Original source by kornrunner
 */
final class Keccak
{
    ...
    private static $keccakf_rndc64 = array(
    ...
    private static $keccakf_rndc32 = array(
